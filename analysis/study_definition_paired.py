...
def colorectal_symp_ref_date_X(name, symp_codelist, ref_codelist, index_date, n, ref_window_weeks=6):
  def var_signature(
    name,
    symp_codelist,
    ref_codelist,
  ...
  variables = var_signature(f"{name}_1_date", symp_codelist, ref_codelist, index_date)
